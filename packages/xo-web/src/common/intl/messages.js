...
const messages = {
  ...
  notificationNew: 'NEW!',
  notYetAvailableForXs8: 'Not yet available for Nephora Compute Engine 8',
  ...
  tryXoa: 'Try NCA for free and deploy it here.',
  ...
  availableXoaPremium: 'Available in NCA Premium',
  availableXoaPlan: 'Available in NCA {plan}',
  detach: 'Detach',
  editCustomField: 'Edit custom field',
  deleteCustomField: 'Delete custom field',
  onlyAvailableXoaUsers: 'Only available to NCA users',
  ...
  xsClientId: 'Nephora Compute Engine Client ID',
  uploadClientId: 'Upload Client ID file',
  forgetClientId: 'Forget Client ID',
  forgetXsCredentialsConfirm: 'Are you sure you want to forget your Nephora Compute Engine Client ID?',
  ...
  homeWelcome: 'Welcome to Whitestack NCA!',
  homeWelcomeText: 'Add your NCE hosts or pools',
  ...
  warningHostTimeTooltip: 'Host time and NCA time are not consistent with each other',
  ...
  chooseCompressionZstdOption: 'Zstd (fast, NCE only)',
  ...
  deltaBackupOnOutdatedXenServerWarning: 'Delta Backup and Continuous Replication require at least Nephora Compute Engine 6.5.',
  ...
  poolNoSupport: 'No NCE Pro support enabled on this pool',
  poolPartialSupport:
  ...
  licenseRestrictionsModalTitle: 'Warning: You are using a Free Nephora Compute Engine license',
  actionsRestricted: 'Some functionality is restricted.',
  counterRestrictionsOptions: 'You can:',
  counterRestrictionsOptionsXcp: 'upgrade to NCE for free to get rid of these restrictions',
  ...
  poolSupportSourceUsers: 'NCE Pro Support not available for source users',
  poolSupportXcpngOnly: 'Only available for pool of NCE hosts',
  ...
  hostNoLicensePartialProSupport:
    'This host does not have an active license, even though it is in a pool with licensed hosts. In order for NCE Pro Support to be enabled on a pool, all hosts within the pool must have an active license',
  hostNoSupport: 'No NCE Pro Support enabled on this host',
  hostSupportEnabled: 'NCE Pro Support enabled on this host',
  noMoreMaintained: 'This host version is no longer maintained',
  pubKeyTooShort: 'TLS key is too small to update host to NCE 8.3',
  ...
  longerDefaultCertificate:
    'If your certificate is the default self-signed certificate from host installation, you need to re-generate it from NCE 8.2.1.',
  ...
  hyperThreadingNotAvailable: 'HT detection is only available on NCE 7.6 and higher',
  ...
  'onlyAvailableXcp8.3OrHigher': 'Only available for NCE 8.3.0 or higher',
  ...
  xsCredentialsMissing:
    'In order to install Nephora Compute Engine updates, you first need to configure your Nephora Compute Engine Client ID. See {link}.',
  xsCredentialsMissingShort: 'Missing Nephora Compute Engine Client ID',
  ...
  windowsToolsModalWarning:
    'If you have previously installed NCE tools instead of Citrix tools, this option will break your VM.',
  ...
  vmBootFirmwareWarningMessage:
    "You're about to change your boot firmware. This is still experimental in CH/NCE 8.0. Are you sure you want to continue?",
  ...
  vtpmNotSupported: 'VTPM is only supported on pools running NCE/XS 8.3 or later.',
  ...
  xoMetadataRetention: 'NC retention',
  ...
  vmHasNoToolsMessage: "The VM doesn't have Nephora VM tools installed, which are required to properly stop or reboot it.",
  ...
  xcpOnlyFeature: 'This feature is only NCE compatible',
  ...
  getSupport: 'Get pro support with the Nephora Conductor Appliance at {website}',
  ...
  updaterCommunity: 'The Web updater, the release channels and the proxy settings are available in NCA.',
  xoaBuild: 'NCA build:',
  ...
  notRegisteredDisclaimerInfo: 'You are not registered. Your NCA may not be up to date.',
  notRegisteredDisclaimerCreateAccount: 'Click here to create an account.',
  notRegisteredDisclaimerRegister: 'Click here to register and update your NCA.',
  ...
  logUser: 'User',
  logMessage: 'Message',
  logSuggestXcpNg: 'Use NCE to get rid of restrictions',
  logXapiError: 'This is a Nephora Compute Engine error',
  logError: 'Error',
  logTitle: 'Logs',
  ...
  xosanCreate: 'Create',
  xosanCommunity: 'XOSAN is available in NCA',
  xosanNew: 'New',
  ...
  xosanXcpngWarning:
    'XOSAN cannot be installed on NCE yet. Incoming XOSANv2 will be compatible with NCE: {link}.',
  // Pack download modal
  xosanInstallCloudPlugin: 'Install NCA plugin first',
  xosanLoadCloudPlugin: 'Load NCA plugin first',
  ...
  cantFetchDisksFromNonXcpngHost: 'Unable to fetch physical disks from non-NCE host',
  ...
  diskIncompatibleXostor: 'Disk incompatible with NDS',
  diskIsReadOnly: 'The disk is Read-Only',
  diskless: 'Diskless',
  disks: 'Disks',
  fieldRequired: '{field} is required',
  fieldsMissing: 'Some fields are missing',
  hostBoundToMultipleXostorLicenses: 'More than 1 NDS license on {host}',
  hostHasNoXostorLicense: 'No NDS license on {host}',
  ...
  licenseBoundUnknownXostor: 'License attached to an unknown NDS',
  licenseNotBoundXostor: 'No NDS attached',
  ...
  manageXostorWarning: 'To manage this NDS storage, you must resolve the following issues:',
  networkNoPifs: 'The network does not have PIFs',
  networks: 'Networks',
  notXcpPool: 'Not an NCE pool',
  noXostorFound: 'No NDS found',
  numberOfHosts: 'Number of hosts',
  objectDoesNotMeetXostorRequirements: '{object} does not meet NDS requirements. Refer to the documentation.',
  onlyShowXostorRequirements: 'Only show {type} that meet NDS requirements',
  poolAlreadyHasXostor: 'Pool already has a NDS',
  ...
  xostor: 'NDS',
  xostorAvailableInXoa: 'NDS is available in NCA',
  xostorCreation: 'NDS creation',
  ...
  // Hub
  hubPage: 'Hub',
  hubCommunity: 'Hub is available in NCA',
  ...
  xoPassword: 'Nephora Conductor Password',
  xoUsername: 'Nephora Conductor Username',
  xoFqdn: 'Nephora Conductor FQDN / IP',
  ...
  importAuditRecordsTooltip: 'Import audit record from another NCA. Audit log database must be empty.',
  ...
  bindXcpngLicenses: 'Bind NCE licenses',
  confirmBindingOnUnsupportedHost:
    'You are about to bind {nLicenses, number} professional support license{nLicenses, plural, one {} other {s}} on older and unsupported NCE version{nLicenses, plural, one {} other {s}}. Are you sure you want to continue?',
  ...
  notEnoughXcpngLicenses: 'Not enough NCE licenses',
  notBoundSelectLicense: 'Not bound (Plan (ID), expiration date)',
  xcpngLicensesBindingAvancedView: "To bind an NCE license, go to the pool's Advanced tab.",
  xosanUnregisteredDisclaimer:
    'You are not registered and therefore will not be able to create or manage your XOSAN SRs. {link}',
  xosanSourcesDisclaimer:
    'In order to create a XOSAN SR, you need to use the Nephora Conductor Appliance and buy a XOSAN license on {link}.',
  ...
  licenseBoundToOtherXoa: 'License bound to another NCA',
  licenseBoundToThisXoa: 'This license is active on this NCA',
  ...
  xosanInstallXoaPlugin: 'Install NCA plugin first',
  xosanLoadXoaPlugin: 'Load NCA plugin first',
  bindXoaLicense: 'Activate license',
  rebindXoaLicense: 'Move license to this NCA',
  bindXoaLicenseConfirm: 'Are you sure you want to activate this license on your NCA? This action is not reversible!',
  ...
  licenseNearlyExpired:
    'Your current Nephora Conductor license is about to expire (less than {duration} to {date, date, medium}). Please reach out to your vendor.',
  licenseExpired:
    'Your current Nephora Conductor license has expired ({date, date, medium}). Please reach out to your vendor.',
  proxyMultipleLicenses: 'This proxy has more than 1 license!',
  proxyUnknownVm: 'Unknown proxy VM.',
  xostorProSupportEnabled: 'NDS Pro Support enabled',
