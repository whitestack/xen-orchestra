  ...
  <UiCard class="home-view">
    ...
    <div class="row">
      ...
      <span class="slots">
        ...
        <UiButton size="medium" accent="brand" variant="primary" @click="slots = 'default'">Default</UiButton>
        <UiButton size="medium" accent="brand" variant="secondary" @click="slots = ''">Clear</UiButton>
      </span>
    </div>
...
function pathToOptionLabel(path: string) {
  return path.replace('../web-core/lib/components/', '[Nephora Conductor Web Core] ').replace('/src/components/', '[Nephora Conductor Lite] ')
}
