...
- NC Lite: a small/light version of Nephora Conductor bundled inside your NCE host.
- NC 6: a large revamp of Nephora Conductor with improved speed, security, lazy loading, NC tasks, a brand new UI and much more!
- Project Pyrgos: easy k8s cluster creation
- NC Tasks: track all actions via NC tasks and not only XAPI tasks
...
- Packer plugin for NC API (already working for NCE API)
