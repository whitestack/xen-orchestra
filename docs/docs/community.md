...
With Nephora Conductor from the sources, you can check your current commit hash in the **About** section:
...
:::tip
If you want a consistent and tested solution for using Nephora Conductor, we strongly advise using our preconfigured and validated [Nephora Conductor Virtual Appliance](installation.md#nca).
:::
...
:::tip
Obviously, NCA users get a higher priority to get new features, since they contribute directly to the project with a subscription. However, your feedback/ideas are always welcome, and the more popular the feature request is, the higher the chances it will be added!
:::
